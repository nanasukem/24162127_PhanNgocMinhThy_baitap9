...
import vn.sukem.entity.OtpToken;
import vn.sukem.repository.OtpTokenRepository;
import vn.sukem.service.EmailService;
import vn.sukem.service.OtpService;
...
public class OtpServiceImpl implements OtpService {
	...
	private void send(String email, String type, String subject) {
		...
		OtpToken token = OtpToken.builder().email(email).otpHash(passwordEncoder.encode(otp)).type(type)
